var Listener = function(manifesturi) {
  ...
  this.cbobj = {
    adStartCb: (function(ev) {
      console.log(this.id + ": Detected ad break at: " + ev.t);
      ...
      console.log(this.id + ": nextAdBreakPts="+this.nextAdBreakPTS+", nextAdBreakStopPTS="+this.nextAdBreakStopPTS);
    }).bind(this),
    adStopCb: (function(ev) {
      console.log(this.id + ": Detected ad break stop at: " + ev.t);
